...
<head>
  ...
  <link rel="apple-touch-icon" sizes="76x76" href="../assets/images /brand/favicon.jpeg">
  <link rel="icon" type="image/png" href="../assets/images  /brand/favicon.jpeg">
          ...
          <div class="row">
            <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
              <div class="card card-plain mt-8">
                <div class="card-header pb-0 text-left bg-transparent">
                  <h3 class="font-weight-bolder text-info text-gradient">Authentification {{$url ?? ''}}</h3>
                ...
                <div class="card-body">
                    ...
                    <label>Login</label>
                    <div class="mb-3">
                      <input class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" class="form-control" placeholder="Email" aria-label="Email" aria-describedby="email-addon">
                    </div>
                    <label>Mot de passe</label>
                    <div class="mb-3">
                      <input id="password" type="password" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" name="password" aria-describedby="password-addon">
                    </div>
            ...
            <div class="col-md-6">
              <div class="oblique position-absolute top-0 h-100 d-md-block d-none me-n8">
                <div class="oblique-image bg-cover position-absolute fixed-top ms-auto h-100 z-index-0 ms-n6" style="background-image:url({{asset('ui/img/curved-images/curved6.jpg')}})"></div>
              </div>
            </div>
          </div>
        </div>
